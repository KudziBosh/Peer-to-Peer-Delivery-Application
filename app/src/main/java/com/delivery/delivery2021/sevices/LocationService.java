package com.delivery.delivery2021.sevices;
...
public class LocationService extends Service {
    ...
    private void getLocation() {
        ...
        mFusedLocationClient.requestLocationUpdates(mLocationRequestHighAccuracy, new LocationCallback() {
                    ...
                    public void onLocationResult(LocationResult locationResult) {
                        ...
                        Log.d(TAG, "getLocation: onLocationResult-> got location result.");
                        ...
                        if (location != null) {
                            ...
                            User_Location userLocation = new User_Location(geoPoint,null, user );
    ...
    private void saveUserLocation(final User_Location userLocation){
            ...
            locationRef.set(userLocation).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if(task.isSuccessful()){
                        Log.d(TAG, "getLocation: onComplete: \ninserted user location into database." +
